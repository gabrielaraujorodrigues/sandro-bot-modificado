...
const menu = (prefix, pushname, NickDono, NomeDoBot, isChVip, isCargo, sender) => {
return`╔♡∞*♡♡∞:｡.｡🩷｡.｡:∞♡*♡:∞♡╗
╠═⪩⟨🧚‍♀️𝐒𝐄𝐉𝐀-𝐁𝐄𝐌-𝐕𝐈𝐍𝐃𝐎(𝐀)⟩
╚♡∞*♡♡∞:｡.｡🩷｡.｡:∞♡*♡:∞♡╝
╭━━⪩ 愛 INFO BOT | USER 愛 ⪨━━
...
│🧚‍♀️⃤${prefix}Lojinha
│🩷⃤${prefix}menuff
│🧚‍♀️⃤${prefix}Menubasico
│🩷⃤${prefix}Menudono
│🧚‍♀️⃤${prefix}Menuadm
│🩷⃤${prefix}Menupremium
│🧚‍♀️⃤${prefix}Efeitosimg
│🩷⃤${prefix}Logos 
│🧚‍♀️⃤${prefix}Brincadeiras
│🩷⃤${prefix}Animes 
│🧚‍♀️⃤${prefix}Menufig
│🩷⃤${prefix}menulink
│🧚‍♀️⃤${prefix}Downloads
...
│🧚‍♀️⃤${prefix}ansiedade
│🩷⃤${prefix}cantadas
│🧚‍♀️⃤${prefix}frasedeamor
│🩷⃤${prefix}frasecriativas
│🧚‍♀️⃤${prefix}frasebonita
│🩷⃤${prefix}deboche
│🧚‍♀️⃤${prefix}safadeza
│🩷⃤${prefix}raiva
│🧚‍♀️⃤${prefix}motivacional
...
│🧚‍♀️⃤${prefix}gerarsenha
│🩷⃤${prefix}gppv
│🧚‍♀️⃤${prefix}apoiarprojeto
│🩷⃤${prefix}pdf (txt)
│🧚‍♀️⃤${prefix}feriados (2026)
│🩷⃤${prefix}ship (@@)
│🧚‍♀️⃤${prefix}sadcat (Gleyce Bot Oficial)
...
│🧚‍♀️⃤${prefix}discord (texto)
│🩷⃤${prefix}biden (Tudo bem?)
│🧚‍♀️⃤${prefix}alugarbot
│🩷⃤${prefix}comprarbot
│🧚‍♀️⃤${prefix}gptvoz (Ola tudo bem?)
│🩷⃤${prefix}rfundo (marcar-imagem)
│🧚‍♀️⃤${prefix}zerotwo (oii)
│🩷⃤${prefix}imgpralink (marcar-img)
│🧚‍♀️⃤${prefix}imgpralink2 (marcar-img)
│🩷⃤${prefix}ensina (90+90)
│🧚‍♀️⃤${prefix}happymod (Free fire)
│🩷⃤${prefix}otakotaku (Naruto)
│🧚‍♀️⃤${prefix}stalktwitter (alanzoka)
│🩷⃤${prefix}tikstalk (sr_gelado19)
│🧚‍♀️⃤${prefix}instastalk (Gleyce Bot Oficial)
│🩷⃤${prefix}youtubetalk (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}pais (Brasil)
│🩷⃤${prefix}dns (https://google.com)
│🧚‍♀️⃤${prefix}traduzir (cat)
│🩷⃤${prefix}totext (marcar-audio)
│🧚‍♀️⃤${prefix}stalkerzap (channel-link)
│🩷⃤${prefix}personagem (Naruto)
│🧚‍♀️⃤${prefix}anime2 (Naruto)
│🩷⃤${prefix}movie (Moana)
│🧚‍♀️⃤${prefix}movielist (Moana)
│🩷⃤${prefix}rgtinder
│🧚‍♀️⃤${prefix}cat
│🩷⃤${prefix}aleatorio
│🧚‍♀️⃤${prefix}dog
...
│🧚‍♀️⃤${prefix}calcular (13+11)
│🩷⃤${prefix}bhaskara (2x²+4x+2 = 0)
│🧚‍♀️⃤${prefix}tagme
│🩷⃤${prefix}raizquadrada (√8)
│🧚‍♀️⃤${prefix}dados
│🩷⃤${prefix}alugar
│🧚‍♀️⃤${prefix}pinterest (anime)
│🩷⃤${prefix}pinterest2 (anime)
│🧚‍♀️⃤${prefix}gtts pt (oii)
│🩷⃤${prefix}tinder
│🧚‍♀️⃤${prefix}vertinder
│🩷⃤${prefix}tinyur (link)
│🧚‍♀️⃤${prefix}encurtalink (link)
│🩷⃤${prefix}games (Minecraft)
│🧚‍♀️⃤${prefix}tomp3 (marcar video)
│🩷⃤${prefix}simi (oii)
│🧚‍♀️⃤${prefix}biografia
│🩷⃤${prefix}arma (AK47)
│🧚‍♀️⃤${prefix}pegadinha
...
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *LOGOS 2 TxT* ⪨━━━
│🧚‍♀️⃤${prefix}thor (Gleyce Bot Oficial)
│🩷⃤${prefix}blackpink2 (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}deadpool (Gleyce Bot Oficial)
│🩷⃤${prefix}amongus2 (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}neon (Gleyce Bot Oficial)
│🩷⃤${prefix}stone3d (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}captainamerica (Gleyce Bot Oficial)
│🩷⃤${prefix}graffiti (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}avengers (Gleyce Bot Oficial)
│🩷⃤${prefix}vintage (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}buoys (Gleyce Bot Oficial)
│🩷⃤${prefix}wood (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}space3d (Gleyce Bot Oficial)
│🩷⃤${prefix}wolf (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}steel (Gleyce Bot Oficial)
│🩷⃤${prefix}lattering (Gleyce Bot Oficial)
│🧚‍♀️⃤${prefix}pornhub (Gleyce Bot Oficial)
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *LOGOS AV* ⪨━━━
│🩷⃤${prefix}amongus [TXT]
│🧚‍♀️⃤${prefix}aniversario [TXT]
│🩷⃤${prefix}zombie [TXT]
│🧚‍♀️⃤${prefix}desfoque [TXT]
│🩷⃤${prefix}glitch [TXT]
│🧚‍♀️⃤${prefix}write [TXT]
│🩷⃤${prefix}colorido [TXT]
│🧚‍♀️⃤${prefix}estrelas [TXT]
│🩷⃤${prefix}naruto [TXT]
│🧚‍♀️⃤${prefix}grafite [TXT]
│🩷⃤${prefix}grafite2 [TXT]
│🧚‍♀️⃤${prefix}advancedglow [TXT]
│🩷⃤${prefix}typography [TXT]
│🧚‍♀️⃤${prefix}pixelglitch [TXT]
│🩷⃤${prefix}neonglitch [TXT]
│🧚‍♀️⃤${prefix}flag [TXT]
│🩷⃤${prefix}flag3d [TXT]
│🧚‍♀️⃤${prefix}deleting [TXT]
│🩷⃤${prefix}glowing [TXT]
│🧚‍♀️⃤${prefix}underwater [TXT]
│🩷⃤${prefix}logomaker [TXT]
│🧚‍♀️⃤${prefix}cartoon [TXT]
│🩷⃤${prefix}papercut [TXT]
│🧚‍♀️⃤${prefix}watercolor [TXT]
│🩷⃤${prefix}effectclouds [TXT]
│🧚‍♀️⃤${prefix}blackpinklogo [TXT]
│🩷⃤${prefix}gradient [TXT]
│🧚‍♀️⃤${prefix}summerbeach [TXT]
│🩷⃤${prefix}luxurygold [TXT]
│🧚‍♀️⃤${prefix}multicoloredneon [TXT]
│🩷⃤${prefix}sandsummer [TXT]
│🧚‍♀️⃤${prefix}galaxywallpaper [TXT]
│🩷⃤${prefix}1917 [TXT]
│🧚‍♀️⃤${prefix}makingneon [TXT]
│🩷⃤${prefix}royal [TXT]
│🧚‍♀️⃤${prefix}freecreate [TXT]
│🩷⃤${prefix}galaxy [TXT]
│🧚‍♀️⃤${prefix}darkgreen [TXT]
│🩷⃤${prefix}lighteffects [TXT]
│🧚‍♀️⃤${prefix}dragonball [TXT]
│🩷⃤${prefix}neondevil [TXT]
│🧚‍♀️⃤${prefix}frozen [TXT]
│🩷⃤${prefix}wooden3d [TXT]
│🧚‍♀️⃤${prefix}metal3d [TXT]
│🩷⃤${prefix}ligatures [TXT]
│🧚‍♀️⃤${prefix}3druby [TXT]
│🩷⃤${prefix}sunset [TXT]
│🧚‍♀️⃤${prefix}cemetery [TXT]
│🩷⃤${prefix}halloween [TXT]
│🧚‍♀️⃤${prefix}horror [TXT]
│🩷⃤${prefix}blood [TXT]
│🧚‍♀️⃤${prefix}joker [TXT]
│🩷⃤${prefix}clouds [TXT]
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *LOGOS* ⪨━━━
│🧚‍♀️⃤${prefix}hackneon [TXT]
│🩷⃤${prefix}fpsmascote [TXT]
│🧚‍♀️⃤${prefix}equipemascote [TXT]
│🩷⃤${prefix}txtquadrinhos [TXT]
│🧚‍♀️⃤${prefix}ffavatar [TXT]
│🩷⃤${prefix}mascotegame [TXT]
│🧚‍♀️⃤${prefix}angelglx [TXT]
│🩷⃤${prefix}gizquadro [TXT]
│🧚‍♀️⃤${prefix}wingeffect [TXT]
│🩷⃤${prefix}blackpink [TXT]
│🧚‍♀️⃤${prefix}girlmascote [TXT]
│🩷⃤${prefix}logogame [TXT]
│🧚‍♀️⃤${prefix}cria [TXT] 
│🩷⃤${prefix}anime1 [TXT]
│🧚‍♀️⃤${prefix}game [TXT]
│🩷⃤${prefix}ff2 [TXT]
│🧚‍♀️⃤${prefix}anime2 [TXT]
│🩷⃤${prefix}entardecer [TXT]
│🧚‍♀️⃤${prefix}dragonredn [TXT]
│🩷⃤${prefix}wolf [TXT]
│🧚‍♀️⃤${prefix}anime2 [TXT]
│🩷⃤${prefix}cria anime1 [TXT]
│🧚‍♀️⃤${prefix}game [TXT]
│🩷⃤${prefix}ff1 [TXT]
│🧚‍♀️⃤${prefix}chufuyu [TXT]
│🩷⃤${prefix}ffgren [TXT]
│🧚‍♀️⃤${prefix}ffrose [TXT]
│🩷⃤${prefix}entardecer [TXT]
│🧚‍♀️⃤${prefix}indian [TXT]
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *MONTAGEM* ⪨━━━
│🩷⃤${prefix}bolsonaro (marca uma imagem) 
│🧚‍♀️⃤${prefix}comunismo (marca uma imagem) 
│🩷⃤${prefix}jail (marca uma imagem) 
│🧚‍♀️⃤${prefix}rip (marca uma imagem) 
...
╭━━━⪩ *FIGURINHAS* ⪨━━━
│🩷⃤${prefix}gura
│🧚‍♀️⃤${prefix}Attp (Seu texto)
│🩷⃤${prefix}Attp1 (Seu texto)
│🧚‍♀️⃤${prefix}Attp2 (Seu texto)
│🩷⃤${prefix}Attp3 (Seu texto)
│🧚‍♀️⃤${prefix}Attp4 (Seu texto)
│🩷⃤${prefix}Attp5 (Seu texto)
│🧚‍♀️⃤${prefix}Attp6 (Seu texto)
│🩷⃤${prefix}Attp7 (Seu texto)
│🧚‍♀️⃤${prefix}Attp8 (Seu texto)
│🩷⃤${prefix}Attp9 (Seu texto)
│🧚‍♀️⃤${prefix}figuperfil
│🩷⃤${prefix}emojimix (😍+🥰)
│🧚‍♀️⃤${prefix}Fsticker (Marcar-foto)
...
│🧚‍♀️⃤${prefix}figumemes (5)
│🩷⃤${prefix}figucoreana (5)
│🧚‍♀️⃤${prefix}figuanime (5)
│🩷⃤${prefix}figuanimais (5)
│🧚‍♀️⃤${prefix}figudesenho (5)
│🩷⃤${prefix}figuraiva (5)
│🧚‍♀️⃤${prefix}figuroblox (5)
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *PESQUISAR* ⪨━━━
│🩷⃤${prefix}xvsearch (Morena)
│🧚‍♀️⃤${prefix}videoporn (link-xv)
...
│🧚‍♀️⃤${prefix}chatgpt2 (ola)
│🩷⃤${prefix}chatgpt3 (ola)
│🧚‍♀️⃤${prefix}clima (Sao Paulo)
│🩷⃤${prefix}clima2 (Sao Paulo)
│🧚‍♀️⃤${prefix}letramusic (mc Kevin)
│🩷⃤${prefix}aptoide (Free fire)
│🧚‍♀️⃤${prefix}aptoidelink (link aptoide)
│🩷⃤${prefix}pesquisa (mc Kevin)
│🧚‍♀️⃤${prefix}print (https://www.xvideos.com/)
│🩷⃤${prefix}Playstore (free fiee)
│🧚‍♀️⃤${prefix}Playstore2 (Minecraft)
│🩷⃤${prefix}ytsearch (mc paiva)
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *Download* ⪨━━━
│🧚‍♀️⃤${prefix}applemusic (mc Kevin)
│🩷⃤${prefix}soundcloud (link)
│🧚‍♀️⃤${prefix}playmix (nome)
│🩷⃤${prefix}playlist (mc paiva)
│🧚‍♀️⃤${prefix}play (nome)
│🩷⃤${prefix}play1 (nome)
│🧚‍♀️⃤${prefix}play2 (nome)
│🩷⃤${prefix}play3 (nome)
│🧚‍♀️⃤${prefix}play4 (nome)
│🩷⃤${prefix}playvideo (nome)
│🧚‍♀️⃤${prefix}facebook (link)
│🩷⃤${prefix}tiktokaudio  (link/tiktok)
│🧚‍♀️⃤${prefix}tiktok (link/tiktok)
│🩷⃤${prefix}tiktok2 (link/tiktok)
│🧚‍♀️⃤${prefix}tiktok3 (nome)
│🩷⃤${prefix}tiktok4 (link/tiktok)
│🧚‍♀️⃤${prefix}ytmp3 (link)
│🩷⃤${prefix}ytmp4 (link)
│🧚‍♀️⃤${prefix}ytdoc (link)
│🩷⃤${prefix}ytsearch (nome)
│🧚‍♀️⃤${prefix}spotify (link)
│🩷⃤${prefix}twitteraudio (link)
│🧚‍♀️⃤${prefix}twittervideo (link)
│🩷⃤${prefix}Instagram (link)
│🧚‍♀️⃤${prefix}Instagramaudio (link)
╰━━━━━─「愛」─━━━━━`;
};
...
╚♡∞*♡♡∞:｡.｡🩷｡.｡:∞♡*♡:∞♡╝
╭══════════════ ⪩
│🩷⃤${prefix}fotobot (marcar-img)
│🩷⃤${prefix}menugif (marcar-video)
│🩷⃤${prefix}Modoaluguel (1/0)
│🩷⃤${prefix}channel (1/0)
│🩷⃤${prefix}Cortesia24
│🩷⃤${prefix}nuke (arquivar-grupo)
...
╚♡∞*♡♡∞:｡.｡🩷｡.｡:∞♡*♡:∞♡╝ 
╭━━━⪩ *LOGOS 2 TXT* ⪨━━━
│🩷⃤${prefix}thor (Gleyce Bot Oficial)
│🩷⃤${prefix}blackpink2 (Gleyce Bot Oficial)
│🩷⃤${prefix}deadpool (Gleyce Bot Oficial)
│🩷⃤${prefix}amongus2 (Gleyce Bot Oficial)
│🩷⃤${prefix}neon (Gleyce Bot Oficial)
│🩷⃤${prefix}stone3d (Gleyce Bot Oficial)
│🩷⃤${prefix}captainamerica (Gleyce Bot Oficial)
│🩷⃤${prefix}graffiti (Gleyce Bot Oficial)
│🩷⃤${prefix}avengers (Gleyce Bot Oficial)
│🩷⃤${prefix}vintage (Gleyce Bot Oficial)
│🩷⃤${prefix}buoys (Gleyce Bot Oficial)
│🩷⃤${prefix}wood (Gleyce Bot Oficial)
│🩷⃤${prefix}space3d (Gleyce Bot Oficial)
│🩷⃤${prefix}wolf (Gleyce Bot Oficial)
│🩷⃤${prefix}steel (Gleyce Bot Oficial)
│🩷⃤${prefix}lattering (Gleyce Bot Oficial)
│🩷⃤${prefix}pornhub (Gleyce Bot Oficial)
╰━━━━━─「愛」─━━━━━
╭━━━⪩ *LOGOS AV* ⪨━━━
│🩷⃤${prefix}amongus [TXT]
│🩷⃤${prefix}aniversario [TXT]
│🩷⃤${prefix}zombie [TXT]
│🩷⃤${prefix}desfoque [TXT]
│🩷⃤${prefix}glitch [TXT]
│🩷⃤${prefix}write [TXT]
│🩷⃤${prefix}colorido [TXT]
│🩷⃤${prefix}estrelas [TXT]
│🩷⃤${prefix}naruto [TXT]
│🩷⃤${prefix}grafite [TXT]
│🩷⃤${prefix}grafite2 [TXT]
...
╚♡∞*♡♡∞:｡.｡🩷｡.｡:∞♡*♡:∞♡╝
╭══════════════ ⪩
│🩷⃤${prefix}placa (placa)
│🩷⃤${prefix}cpf (cpf)
│🩷⃤${prefix}cpf2 (cpf)
│🩷⃤${prefix}nome (nome)
│🩷⃤${prefix}cep (numero)
│🩷⃤${prefix}cep2 (numero)
│🩷⃤${prefix}cnpj (numero)
│🩷⃤${prefix}banco (001)
│🩷⃤${prefix}bancos
╰═══════════════ ⪨`;
};
...
╰╦══════════════════ ⪨
╭┤𝐁𝐑𝐈𝐍𝐂𝐀𝐃𝐄𝐈𝐑𝐀𝐒
│🩷⃤${prefix}pgpau (marca (@))
│🩷⃤${prefix}pgbunda (marca (@))
...
│🩷⃤${prefix}figuflork (5)
│🩷⃤${prefix}figumemes (5)
│🩷⃤${prefix}figucoreana (5)
│🩷⃤${prefix}figuanime (5)
│🩷⃤${prefix}figuanimais (5)
│🩷⃤${prefix}figudesenho (5)
│🩷⃤${prefix}figuraiva (5)
│🩷⃤${prefix}figuroblox (5)
