...
const banner2 = cfonts.render((`Gleyce Bot Oficial V27 | CRIADOR: SANDRO | CANAL: Gleyce Bot Oficial | GRUPO: https://chat.whatsapp.com/ExCKNRkLlFgKZkCZDX2nIA`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`SANDRO|MD V27`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
